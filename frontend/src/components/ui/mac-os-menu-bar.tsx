    ...
    <div style={{ position: 'relative' }}>
      ...
      >
        <div className="flex justify-between items-center h-full px-4">
          {/* Left section - App icon and menus */}
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Clock */}
            <span
              className="text-white text-sm font-medium select-none ml-1 cursor-pointer hover:opacity-80 transition-opacity duration-150"
            >
              {currentTime}
            </span>
          </div>
